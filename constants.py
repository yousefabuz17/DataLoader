...
_ERRORS = {
        ...
        1: 'CODE 1: NoDundersOrDynamicError>>The provided {!r} does not support the required {!r} __dunder__ methods or lacks {!r} capabilities.\n>>Please include the necessary dynamic arguments, otherwise, initialize the {!r} with the default instance ({!r}).\n>>If the issue persists, ensure that the {!r} object has been correctly initialized and invoked.\n>>Additionally, double-check all instances are correct.',
