...
_ERRORS = {
        ...
        50: 'CODE 50: DataManagerNoPosixError>>No valid paths were found. Please ensure that the \'posix\' attribute is enabled (if previously from {!r} object) and that all specified paths are validated and class object is invoked.\n>>ERROR: {}',
        ...
        800: 'CODE 800: AttributeError>>This method is not valid {!r}',
