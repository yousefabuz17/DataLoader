...
_ERRORS = {
        ...
        50: 'CODE 50: DataManagerNoPosixError>>No valid paths were found. Please ensure that the \'posix\' attribute is enabled (if previously from {!r} object) and that all specified paths are validated.\n>>ERROR: {}',
